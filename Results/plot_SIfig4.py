...
df_sup = df_sup.rename(columns = {'N_CELLS_i':'N_CELLS_REP'})
df = plot_R2_cat(df_sup,'N_CELLS_REP','Analysis')
...
df_sup10['Analysis'] = 'Supervised'
df_sup = pd.concat([df_sup1,df_sup2,df_sup3,df_sup4,df_sup5,df_sup6,df_sup7,df_sup8,df_sup9,df_sup10], axis=0)
df_sup = df_sup.rename(columns = {'N_CELLS_c':'N_CELLS_MIN'})

df = plot_R2_cat(df_sup,'N_CELLS_MIN','Analysis')
