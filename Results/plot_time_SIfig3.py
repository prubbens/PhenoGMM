...
h.set(ylim=(0,0.75))
plt.savefig('Figures/SI/Time_complexity_PhenoGMM_UNS.png',dpi=500, bbox_tight=True)
plt.show()
...
plt.savefig('Figures/SI/Time_complexity_PhenoGMM_SUP.png',dpi=500, bbox_tight=True)
plt.show()